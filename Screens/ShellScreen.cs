...
/// <summary>Shared chrome for every screen in the app: a blank line, the app title, a blank line,
/// the preview box, a blank line, this screen's own content ("middle"), a blank line, and a
/// left-aligned help bar — with any leftover space as a blank filler at the very bottom. Both
/// <see cref="MainScreen"/> and every field editor (via <see cref="MultiStepScreen"/>) render
/// through this so the title and preview are always visible and the spacing is identical
/// everywhere.</summary>
